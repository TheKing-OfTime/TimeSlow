...
from Lib import db_valid_cheker, get_guild_language, data, disagree_emoji, lang, is_Moderator, db_load_req, agree_emoji, warning_emoji, db_dump_req, sd_log, usd_log
...
class WorkWithMemberDB(commands.Cog):
    ...
    async def slowdown(self, ctx, member: discord.Member, interval, unmute_in='0'):
        if await db_load_req(
            ...
            await sd_log(ctx, member, interval, unmute_in)
